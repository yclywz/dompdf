...
//     pre_r($words);
	...
	/* BUG FIX by Matthias Moser : post@matthias-moser.de
	* Decode all words from utf8 to provide correct word lenght calculation.
	* Only tested with german umlauts.
	*/	
	for($i = 0; $i < count($words); $i++){
		$words[$i] = utf8_decode($words[$i]);
	}
	/* BUG FIX END */
