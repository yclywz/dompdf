...
if (DEBUGCSS) {
/*DEBUGCSS*/$debug_nodename = $frame->get_node()->nodeName;
/*DEBUGCSS*/print "<pre>\n[$debug_nodename\n";
/*DEBUGCSS*/        foreach ($applied_styles as $spec => $arr) {
/*DEBUGCSS*/          printf("specificity: 0x%08x\n",$spec);
/*DEBUGCSS*/          foreach ($arr as $s) {
/*DEBUGCSS*/            print "[\n";
/*DEBUGCSS*/            $s->debug_print();
/*DEBUGCSS*/            print "]\n";
/*DEBUGCSS*/          }
/*DEBUGCSS*/        }
}
...
if (DEBUGCSS) {
/*DEBUGCSS*/          print "inherit:\n";
/*DEBUGCSS*/            print "[\n";
/*DEBUGCSS*/            $p->get_style()->debug_print();
/*DEBUGCSS*/            print "]\n";
}
...
if (DEBUGCSS) {
/*DEBUGCSS*/          print "DomElementStyle:\n";
/*DEBUGCSS*/            print "[\n";
/*DEBUGCSS*/            $style->debug_print();
/*DEBUGCSS*/            print "]\n";
/*DEBUGCSS*/ print "/$debug_nodename]\n</pre>";
}
