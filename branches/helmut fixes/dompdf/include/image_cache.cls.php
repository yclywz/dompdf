...
//debugpng
if (DEBUGPNG) $full_url = '(blockedremote)';
...
//debugpng
if (DEBUGPNG) $full_url = '(nocache)';
    }

//debugpng
if (DEBUGPNG) print '[resolve_url '.$url.'|'.$full_url.'|'.$resolved_url.'|'.$ext.']';
